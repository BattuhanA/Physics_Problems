# 🚗 Relative Uncertainty Problem

## ❓ Question
A car's speedometer has a **5% uncertainty**.  
If the speedometer reads **60 km/h**, what is the range of the car's actual speed?
...
# 🧮 Step 1: Calculate the Uncertainty Amount
